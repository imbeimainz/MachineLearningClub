...
Smooth: valid approximation `f(x + epsilon_x) = y + a * epsilon_x`, close to point `p`

Slope `a`: the **derivative** of f in p  
a > 0: f(x) increases + magnitude of a tells how quickly it does

![](images/ss_derivative.png)
What's in it for DL?  
