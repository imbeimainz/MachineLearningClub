...
# 7.1 Beyond sequential models: Multimodal Models and the Keras functional API
...
Recent applications worth mentioning:
...
> Note that `lstm` has brackets, `merged` does not.

> (I'm unsure wheter these brackets are really needed...)
