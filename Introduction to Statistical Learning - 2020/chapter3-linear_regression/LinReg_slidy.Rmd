...
- Root of the derivative $\frac{d\text{RSS}}{d\beta} \stackrel{!}= 0$ yields
...
$$ 
Y = 2 + 3\cdot X + \eps  \eps \stackrel{i.i.d.}{\sim}N(0,4)
$$ 
i.e. the true $\beta_0$,  $\beta_1$ are 2 and 3, respectively.
...
abline(2,3,col="red",lwd=2)
```
Left: sample of $n:=100$ observations. True regression line in red, sample based
regression line in blue.  
Right: sample-based regression lines of 100 samples
