...
- `persp()` to produce a three-dimensional plot
known as a heatmap, and is sometimes used to plot temperature in weather forecasts. Alternatively, persp() can be used to . The arguments theta and phi control the angles at which the plot is persp() viewed.
